          ...
          {spotify.playlists.map((playlist) => (
            ...
            >
              ...
              <div className="relative mb-2 flex items-center justify-between gap-2 md:mb-3 md:gap-3">
                ...
                <div className="shrink-0 rounded-full border border-[rgb(var(--pk-accent-rgb)/0.35)] bg-[rgb(var(--pk-accent-rgb)/0.10)] px-2.5 py-1 text-[8px] font-semibold uppercase tracking-[0.16em] text-[var(--pk-accent)] md:px-3 md:text-[9px] md:tracking-[0.22em]">
                  {spotify.badgeLabel}
                </div>
              </div>
